        ...
        try {
            ...
            while (reader.hasNextLine()) {
                int[][] nextNine = {
                        ...
                        {reader.nextInt(), reader.nextInt(), reader.nextInt()},
                        {reader.nextInt(), reader.nextInt(), reader.nextInt()}};
                calcTriangles(nextNine[0][0],nextNine[1][0], nextNine[2][0]);
                calcTriangles(nextNine[0][1],nextNine[1][1], nextNine[2][1]);
                calcTriangles(nextNine[0][2],nextNine[1][2], nextNine[2][2]);
